...
export default function QuickQuoteWidget({ variant = "hero", onGetFullQuote }: QuickQuoteWidgetProps) {
  ...
  const containerClass = variant === "hero"
    ...
    : variant === "sidebar"
    ? "bg-white rounded-xl shadow-lg p-5 w-full"
        ...
        {step === 1 && (
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-2">
              <Sparkles className="w-5 h-5 text-heritage-accent" />
            ...
            <div className="flex gap-2 mb-6">
              <div className="h-1.5 flex-1 rounded-full bg-heritage-primary" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-lg border border-gray-300 rounded-xl focus:ring-2 focus:ring-heritage-primary focus:border-transparent"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-heritage-primary text-white rounded-xl font-semibold hover:bg-heritage-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Continue
            ...
            <div className="flex items-center justify-center gap-4 mt-6 pt-4 border-t border-gray-100">
              ...
              <div className="flex items-center gap-1 text-xs text-gray-500">
                <Clock className="w-3.5 h-3.5 text-heritage-primary" />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-heritage-primary focus:border-transparent"
                    placeholder="John"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      className="flex-1 px-2 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-heritage-primary focus:border-transparent"
                    >
                      {[4, 5, 6, 7].map((ft) => (
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  onClick={handleNext}
                  disabled={!isStepValid()}
                  className="flex-1 flex items-center justify-center gap-2 px-6 py-2.5 bg-heritage-primary text-white rounded-xl font-semibold hover:bg-heritage-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  Continue
                  <ArrowRight className="w-4 h-4" />
                </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  onClick={handleNext}
                  disabled={!isStepValid()}
                  className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-heritage-primary text-white rounded-xl font-semibold hover:bg-heritage-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
