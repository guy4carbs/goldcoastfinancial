...
export function GCStatRow({ label, value, max, formatter = (v) => v.toLocaleString() }: GCStatRowProps) {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="flex-1 h-6 relative" style={{ backgroundColor: "var(--gc-surface-2)", borderRadius: "0px" }}>
        <div className="absolute inset-y-0 left-0" style={{ width: `${pct}%`, backgroundColor: "var(--gc-gold)", borderRadius: "0px", transition: "width var(--gc-transition-normal)" }} />
      </div>
