...
function colorForType(type: string): string {
  switch (type) {
    case "expiration":
      return "var(--gc-status-warning, #E07060)";
    case "milestone":
      return "var(--gc-status-active, #7EC8A4)";
    case "admin_message":
      return "var(--gc-status-review, #A8C4E0)";
    default:
      return "var(--gc-gold, #C4975A)";
  }
}
...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} data-tour-id="hcms-shell-notifications" style={{ position: "relative" }}>
      <button
        onClick={() => setOpen((o) => !o)}
        className="p-2 rounded-sm relative"
        style={{
          color: open ? "var(--gc-gold)" : "var(--gc-text-secondary)",
          background: open ? "color-mix(in srgb, var(--gc-gold) 12%, transparent)" : "transparent",
          border: open ? "1px solid var(--gc-gold)" : "1px solid transparent",
        ...
        {effectiveUnread > 0 && (
          <span
            ...
            style={{
              ...
              boxShadow: "0 0 0 2px var(--gc-surface, #3A1018)",
            }}
          >
      ...
      {open && (
        <div
          style={{
            ...
            overflow: "hidden",
            animation: "gc-notif-in 180ms cubic-bezier(0.22, 1, 0.36, 1)",
          }}
        >
          <style>{`
            @keyframes gc-notif-in {
          ...
          >
            <div style={{ fontSize: 13, fontWeight: 600, color: "var(--gc-text-primary)", letterSpacing: 0.1 }}>
              Notifications
              {effectiveUnread > 0 && (
                <span style={{ marginLeft: 8, color: "var(--gc-gold)", fontWeight: 500 }}>
            ...
            {effectiveUnread > 0 && (
              <button
                ...
                onMouseEnter={(e) => (e.currentTarget.style.background = "var(--gc-hover-overlay)")}
          ...
          <div style={{ overflowY: "auto", flex: 1, minHeight: 120 }}>
            {loading && items.length === 0 ? (
              <div style={{ padding: 24, textAlign: "center", color: "var(--gc-text-muted)", fontSize: 12 }}>
                Loading…
              </div>
            ) : items.length === 0 ? (
              <div style={{ padding: 36, textAlign: "center", color: "var(--gc-text-muted)" }}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "12px 14px",
                      background: isUnread ? "color-mix(in srgb, var(--gc-gold) 6%, transparent)" : "transparent",
                      border: "none",
                      borderBottom: "1px solid var(--gc-border-subtle)",
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.background = isUnread
                        ? "color-mix(in srgb, var(--gc-gold) 6%, transparent)"
                        : "transparent")
                    }
                  >
                    <div
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        <div style={{ fontSize: 10.5, color: "var(--gc-text-muted)", flexShrink: 0 }}>
                          {timeAgo(n.createdAt)}
                        </div>
                      </div>
                      <div
