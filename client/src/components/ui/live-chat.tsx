...
const botResponses: { [key: string]: string } = {
  ...
  "talk to an agent": "Great! Our team is available Monday-Friday, 9am-5pm CT. You can call us at (630) 478-1835, or leave your contact info and we'll reach out within 24 hours.",
