...
import { ArrowRight, ShieldCheck, HeartHandshake, Star, MapPin, Quote, Calculator } from "lucide-react";
import heroImage from "@assets/generated_images/happy_multi-generational_family_in_a_park.png";
import { motion } from "framer-motion";
import { HeritageAnimatedStats } from "@/components/ui/heritage-animated-stats";
import { HeritageCarrierPartners } from "@/components/ui/heritage-carrier-partners";
import { HeritageBeforeAfterScenarios } from "@/components/ui/heritage-before-after-scenarios";
import { HeritageIndependentAgencyCTA } from "@/components/ui/heritage-independent-agency-cta";
...
const testimonials = [
  ...
  },
  {
    name: "Thomas H.",
    location: "Denver, CO",
    text: "Heritage Life Solutions is the real deal. Marcus Williams found me a term policy at half the price I was quoted elsewhere. Can't thank them enough!",
  ...
  },
  {
    ...
    text: "We've been with Heritage Life for 5 years now. Frank Carbonara always makes sure our coverage keeps up with our growing family.",
    agent: "Frank Carbonara",
    rating: 5
  },
  {
  ...
  },
  {
    name: "James & Carol B.",
    location: "Chicago, IL",
    text: "The team at Heritage Life Solutions treats you like family. Gaetano has been our advisor for years and we wouldn't go anywhere else.",
    agent: "Gaetano Carbonara",
    rating: 5
  },
  {
...
function TestimonialCard({ testimonial }: { testimonial: typeof testimonials[0] }) {
  return (
    <div className="flex-shrink-0 w-[280px] md:w-[320px] mx-3">
      <Card className="h-full shadow-md hover:shadow-lg transition-shadow" style={{ backgroundColor: c.white, borderColor: c.muted }}>
        <CardContent className="p-4 md:p-6">
          <div className="flex gap-1 mb-3">
            {[...Array(testimonial.rating)].map((_, i) => (
              <Star key={i} className="w-4 h-4 fill-current" style={{ color: c.secondary }} />
            ))}
          </div>
          <Quote className="w-8 h-8 mb-2" style={{ color: `${c.secondary}50` }} />
          ...
          <div className="border-t pt-4" style={{ borderColor: c.muted }}>
            <p className="font-bold" style={{ color: c.primary }}>{testimonial.name}</p>
            <p className="text-xs" style={{ color: c.textSecondary }}>{testimonial.location}</p>
            <p className="text-xs font-medium mt-1" style={{ color: c.secondary }}>Worked with {testimonial.agent}</p>
          </div>
        </CardContent>
      </Card>
    </div>
...
export default function Heritage() {
  return (
    <HeritageLayout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-medium tracking-wide uppercase text-sm" style={{ color: c.secondary }}>Chicagoland's Trusted Agency - Serving All 50 States</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/heritage/get-quote">
                <Button size="lg" className="text-lg px-8 h-14 rounded-md" style={{ backgroundColor: c.primary, color: c.white }}>
                  Get a Free Quote
                </Button>
              </Link>
      ...
      {/* Animated Stats */}
      <HeritageAnimatedStats />

      {/* Carrier Partners */}
      <HeritageCarrierPartners />

      {/* Why Choose Us */}
      <section className="py-24" style={{ backgroundColor: c.background }}>
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-serif mb-4" style={{ color: c.primary }}>Why Choose Heritage Life Solutions?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="border-none shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300" style={{ backgroundColor: c.white }}>
                  <CardContent className="pt-8 px-8 pb-8 text-center">
                    <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: `${c.primary}10` }}>
                      <feature.icon className="w-8 h-8" style={{ color: c.primary }} />
                    </div>
                    <h3 className="text-xl font-bold mb-3" style={{ color: c.primary }}>{feature.title}</h3>
                    <p className="leading-relaxed" style={{ color: c.textSecondary }}>{feature.desc}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ backgroundColor: `${c.secondary}30` }}>
                  <Calculator className="w-7 h-7" style={{ color: c.secondary }} />
                </div>
                <div>
              ...
              <div className="flex flex-col items-center md:items-end gap-2">
                <Link href="/heritage/calculator">
                  <Button size="lg" className="font-semibold whitespace-nowrap" style={{ backgroundColor: c.secondary, color: c.white }}>
      ...
      <section className="py-20 overflow-hidden" style={{ backgroundColor: c.white }}>
        <div className="container mx-auto px-4 mb-12">
          <div className="text-center">
            <span className="font-bold uppercase tracking-wide text-sm mb-2 block" style={{ color: c.secondary }}>What Our Clients Say</span>
            <h2 className="text-3xl md:text-4xl font-bold font-serif" style={{ color: c.primary }}>Real Stories from Real Families</h2>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div className="max-w-2xl">
              <span className="font-bold uppercase tracking-wide text-sm mb-2 block" style={{ color: c.secondary }}>Our Solutions</span>
              <h2 className="text-3xl md:text-4xl font-bold font-serif" style={{ color: c.primary }}>Comprehensive Coverage Options</h2>
            </div>
            <Link href="/heritage/products">
              <Button variant="link" className="font-semibold group p-0 mt-4 md:mt-0" style={{ color: c.primary }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <Link href="/heritage/products">
                  <div
                    className="group p-6 border rounded-lg hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer h-full"
                    style={{ backgroundColor: c.white, borderColor: c.secondary }}
                  >
                    <h3 className="text-xl font-bold mb-2 transition-colors" style={{ color: c.primary }}>{item.title}</h3>
                    <p className="text-sm mb-4" style={{ color: c.textSecondary }}>{item.desc}</p>
                    <div className="flex items-center text-sm font-semibold group-hover:translate-x-1 transition-transform" style={{ color: c.secondary }}>
          ...
          <div className="mt-12">
            <HeritageIndependentAgencyCTA />
          </div>
        </div>
      </section>

      {/* Before/After Scenarios */}
      <HeritageBeforeAfterScenarios />

      {/* FAQ Section */}
      <HeritageFAQSection />

      {/* CTA Section */}
      <section className="py-20 relative overflow-hidden" style={{ backgroundColor: c.primary }}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/heritage/get-quote">
              <Button size="lg" className="font-bold text-lg px-10 hover:scale-105 transition-transform" style={{ backgroundColor: c.secondary, color: c.white }}>
                Get Your Free Quote
              </Button>
            </Link>
            <Link href="/heritage/contact">
