    ...
    <div className="min-h-screen bg-[#fffaf3]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Keep your family
                <span className="text-heritage-accent"> in their home.</span>
              </h1>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">What is Mortgage Protection Insurance?</h2>
      ...
      <section className="py-16 bg-heritage-primary">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Protect your family's home</h2>
          <p className="text-xl text-white/80 mb-8">
