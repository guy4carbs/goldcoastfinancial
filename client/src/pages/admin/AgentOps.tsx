    ...
    <div className="min-h-screen bg-background p-4 md:p-8 space-y-6">
        ...
        {killSwitchConfirm && (
          ...
          >
            <motion.div
              ...
              className="bg-card border border-destructive/50 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl"
            >
              ...
              <div className="flex gap-3 justify-end">
                <Button variant="outline" onClick={() => setKillSwitchConfirm(false)}>
                  Cancel
                </Button>
                <Button
                  variant="destructive"
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {tiers.map((tierData) => (
            <Card key={tierData.tier} className="overflow-hidden">
              <button
        ...
        <div className="space-y-4">
          ...
          <Card className="max-h-[700px] overflow-hidden flex flex-col">
