...
const DEMO_AGENT_CLAIMS: AgentClaim[] = [
  {
    ...
    clientEmail: 'john.mitchell@email.com',
    clientPhone: '(407) 555-0192',
    policyId: 'pol-3',
    policyNumber: 'HLS-2023-20156',
    policyType: 'IUL',
    carrier: 'Lincoln Financial',
    claimType: 'Living Benefits',
    status: 'under_review',
    priority: 'high',
    ...
    carrierClaimNumber: 'LFG-2026-88421',
    estimatedResolution: 'Apr 8, 2026',
    documentsRequired: [
      { name: 'Medical Records', description: 'Recent medical records and diagnosis', required: true, submitted: true },
      { name: 'Physician Statement', description: 'Attending physician statement', required: true, submitted: false },
      { name: 'Claim Form', description: 'Accelerated benefit claim form', required: true, submitted: true },
    ],
    notes: [
      { id: 'note-1', author: 'Sarah Johnson', date: 'Mar 8, 2026', content: 'Submitted to Lincoln Financial. Awaiting physician statement from Dr. Patel.', type: 'internal' },
      { id: 'note-2', author: 'System', date: 'Mar 5, 2026', content: 'Status changed from Pending Documents to Under Review', type: 'status_change' },
      { id: 'note-3', author: 'Sarah Johnson', date: 'Feb 22, 2026', content: 'Client provided initial medical records. Qualifying condition confirmed under rider.', type: 'internal' },
      { id: 'note-4', author: 'System', date: 'Feb 20, 2026', content: 'Claim filed by client through Client Lounge', type: 'status_change' },
    ],
  },
  {
    id: 'claim-2',
    ...
    carrierClaimNumber: 'MOO-2025-44218',
    estimatedResolution: 'Nov 30, 2025',
    documentsRequired: [
      { name: 'Disability Certification', description: 'Physician certification of disability', required: true, submitted: true },
      { name: 'Employer Statement', description: 'Employer statement of disability', required: true, submitted: true },
      { name: 'Claim Form', description: 'Disability claim form', required: true, submitted: true },
    ],
    notes: [
      { id: 'note-5', author: 'System', date: 'Nov 28, 2025', content: 'Claim approved by Mutual of Omaha. Premium waiver active for 12 months.', type: 'status_change' },
      { id: 'note-6', author: 'Sarah Johnson', date: 'Nov 10, 2025', content: 'All documents submitted to carrier. Processing within standard 14-day window.', type: 'internal' },
      { id: 'note-7', author: 'System', date: 'Oct 22, 2025', content: 'Status changed from Pending Documents to Under Review', type: 'status_change' },
      { id: 'note-8', author: 'System', date: 'Oct 15, 2025', content: 'Claim filed by client through Client Lounge', type: 'status_change' },
    ],
  },
  {
    id: 'claim-3',
    ...
    status: 'filed',
    priority: 'critical',
    description: 'Accidental death benefit rider claim filed — supporting documentation pending.',
    amount: 500000,
    ...
    notes: [
      { id: 'note-9', author: 'System', date: 'Mar 10, 2026', content: 'CRITICAL: Accidental death claim filed. 24-hour response required.', type: 'status_change' },
    ],
  },
];
