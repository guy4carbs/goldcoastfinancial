...
export default function AgentPortal() {
  ...
  const inputStyle = { padding: "var(--gc-space-2) var(--gc-space-3)", backgroundColor: "var(--gc-surface-2)", border: "1px solid var(--gc-border)", borderRadius: "2px", color: "var(--gc-text-primary)", fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-md)", width: "100%" };
      ...
      <div className="sticky top-0 z-40" style={{ backgroundColor: "var(--gc-surface)", borderBottom: "1px solid var(--gc-border)" }}>
        ...
        <div className="max-w-2xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div style={{ padding: "var(--gc-space-2)", backgroundColor: "var(--gc-gold)", borderRadius: "0px" }}><Shield className="w-4 h-4" style={{ color: "var(--gc-btn-primary-text)" }} /></div>
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        {step === 0 && (
          <div className="text-center py-8">
            ...
            <button onClick={next} style={{ padding: "var(--gc-space-3) var(--gc-space-8)", backgroundColor: "var(--gc-btn-primary-bg)", color: "var(--gc-btn-primary-text)", borderRadius: "2px", border: "none", cursor: "pointer", fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-lg)", fontWeight: 600 }}>BEGIN APPLICATION</button>
          </div>
        )}
        ...
        {step === 5 && (
          <div>
            ...
            {["E&O Certificate (PDF)", "W-9 Form (PDF)", "Government ID (optional)"].map(doc => (
              <div key={doc} style={{ padding: "var(--gc-space-6)", backgroundColor: "var(--gc-surface-2)", border: "2px dashed var(--gc-border)", borderRadius: "0px", textAlign: "center", marginBottom: "var(--gc-space-4)", cursor: "pointer" }}>
        ...
        {step === 6 && (
          <div>
            ...
            <div style={{ backgroundColor: "var(--gc-surface)", border: "1px solid var(--gc-border)", borderRadius: "0px", padding: "var(--gc-space-4)", marginBottom: "var(--gc-space-4)" }}>
        ...
        {step > 0 && step < 6 && (
          <div className="flex justify-between mt-8">
            <button onClick={prev} style={{ padding: "var(--gc-space-2) var(--gc-space-4)", backgroundColor: "var(--gc-surface)", color: "var(--gc-text-secondary)", borderRadius: "2px", border: "1px solid var(--gc-border)", cursor: "pointer", fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-base)" }}>Back</button>
            <button onClick={next} style={{ padding: "var(--gc-space-2) var(--gc-space-4)", backgroundColor: "var(--gc-btn-primary-bg)", color: "var(--gc-btn-primary-text)", borderRadius: "2px", border: "none", cursor: "pointer", fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-base)", fontWeight: 500 }}>Continue</button>
          </div>
        )}
        {step === 6 && (
