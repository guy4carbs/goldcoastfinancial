  ...
  return (
    <div className="space-y-4">
      <div className="bg-gray-50 rounded-lg p-4">
        <h4 className="font-medium text-sm mb-3">Map your columns to CRM fields</h4>
...
function ExportBuilder({ onExport, isExporting }: ExportBuilderProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Export Type */}
      <div>
        <Label className="text-sm font-medium">What do you want to export?</Label>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Bulk import leads from CSV/Excel or export your data
          </p>
        </div>
