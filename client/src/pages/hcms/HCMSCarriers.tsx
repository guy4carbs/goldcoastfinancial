...
import { ChevronDown, ChevronRight, ExternalLink, Search, Globe, Phone, Mail } from "lucide-react";
...
const CARRIERS: Carrier[] = [
  { id: "1", name: "Aetna", amBest: "A", naic: "60054", products: ["Term Life", "Whole Life"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "3", name: "Michael Chen", writing: "AET-330100", date: "2025-06-01", level: "85%" }], phone: "(800) 872-3862", email: "contracting@aetna.com", website: "aetna.com", contractingUrl: "https://www.surelc.com", trainingUrl: "", advanceMonths: 9, avgProcessingDays: 10 },
  ...
  { id: "4", name: "Americo", amBest: "A", naic: "68594", products: ["Term Life", "Whole Life", "IUL", "Final Expense", "Annuity"], statesCount: 49, states: ["49 states"], agentsAppointed: [{ agentId: "2", name: "James Rodriguez", writing: "AMR-334201", date: "2025-02-01", level: "75%" }, { agentId: "3", name: "Michael Chen", writing: "AMR-441003", date: "2024-08-01", level: "85%" }, { agentId: "5", name: "David Park", writing: "AMR-552134", date: "2024-09-01", level: "80%" }], phone: "(800) 231-0801", email: "contracting@americo.com", website: "americo.com", contractingUrl: "https://www.surelc.com", trainingUrl: "https://training.americo.com", advanceMonths: 9, avgProcessingDays: 7 },
  ...
  { id: "8", name: "Corebridge Financial", amBest: "A", naic: "70238", products: ["Term Life", "Whole Life", "IUL", "Annuity"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "3", name: "Michael Chen", writing: "CBF-112204", date: "2025-01-20", level: "90%" }, { agentId: "5", name: "David Park", writing: "CBF-223315", date: "2025-03-01", level: "83%" }], phone: "(800) 448-2542", email: "contracting@corebridgefinancial.com", website: "corebridgefinancial.com", contractingUrl: "https://www.surelc.com", trainingUrl: "https://training.corebridge.com", advanceMonths: 9, avgProcessingDays: 10 },
  ...
  { id: "10", name: "Foresters Financial", amBest: "A", naic: "58188", products: ["Term Life", "Whole Life", "Final Expense"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "9", name: "Jack Cook", writing: "FOR-100010", date: "2023-01-01", level: "100%" }], phone: "(800) 828-1540", email: "contracting@foresters.com", website: "foresters.com", contractingUrl: "https://www.surelc.com", trainingUrl: "", advanceMonths: 9, avgProcessingDays: 7 },
  ...
  { id: "15", name: "Mutual of Omaha", amBest: "A+", naic: "71412", products: ["Term Life", "Whole Life", "IUL", "Final Expense", "Annuity", "Mortgage Protection"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "1", name: "Sarah Mitchell", writing: "MOO-445821", date: "2024-06-15", level: "85%" }, { agentId: "3", name: "Michael Chen", writing: "MOO-556932", date: "2024-03-15", level: "90%" }, { agentId: "5", name: "David Park", writing: "MOO-667845", date: "2024-04-01", level: "83%" }, { agentId: "9", name: "Jack Cook", writing: "MOO-100001", date: "2022-01-15", level: "100%" }], phone: "(800) 775-6000", email: "contracting@mutualofomaha.com", website: "mutualofomaha.com", contractingUrl: "https://www.surelc.com", trainingUrl: "https://salesnet.mutualofomaha.com", advanceMonths: 9, avgProcessingDays: 5 },
  { id: "16", name: "National Life Group", amBest: "A", naic: "66680", products: ["Term Life", "Whole Life", "IUL", "Annuity"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "1", name: "Sarah Mitchell", writing: "NLG-228110", date: "2025-01-15", level: "82%" }, { agentId: "3", name: "Michael Chen", writing: "NLG-339211", date: "2025-04-01", level: "88%" }, { agentId: "9", name: "Jack Cook", writing: "NLG-100005", date: "2023-01-01", level: "100%" }], phone: "(800) 732-8939", email: "contracting@nationallife.com", website: "nationallife.com", contractingUrl: "https://www.surelc.com", trainingUrl: "", advanceMonths: 9, avgProcessingDays: 10 },
  ...
  { id: "21", name: "Transamerica", amBest: "A", naic: "86231", products: ["Term Life", "Whole Life", "IUL", "Final Expense", "Annuity"], statesCount: 50, states: ["ALL"], agentsAppointed: [{ agentId: "1", name: "Sarah Mitchell", writing: "TRA-118904", date: "2024-07-01", level: "80%" }, { agentId: "2", name: "James Rodriguez", writing: "TRA-229015", date: "2024-09-01", level: "78%" }, { agentId: "3", name: "Michael Chen", writing: "TRA-330122", date: "2024-05-01", level: "88%" }, { agentId: "4", name: "Emily Watson", writing: "TRA-441223", date: "2025-06-01", level: "80%" }, { agentId: "6", name: "Lisa Thompson", writing: "TRA-661102", date: "2025-08-01", level: "78%" }, { agentId: "9", name: "Jack Cook", writing: "TRA-100002", date: "2022-02-01", level: "100%" }], phone: "(800) 797-2643", email: "contracting@transamerica.com", website: "transamerica.com", contractingUrl: "https://www.surelc.com", trainingUrl: "https://training.transamerica.com", advanceMonths: 9, avgProcessingDays: 7 },
...
const totalAppointed = CARRIERS.reduce((s, c) => s + c.agentsAppointed.length, 0);
...
export default function HCMSCarriers() {
  ...
  const counts = { all: CARRIERS.length, life: CARRIERS.filter(c => c.products.some(p => p.includes("Life") && p !== "Final Expense")).length, annuity: CARRIERS.filter(c => c.products.includes("Annuity")).length, fe: CARRIERS.filter(c => c.products.includes("Final Expense")).length };
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search carriers..." style={{ paddingLeft: 36, padding: "var(--gc-space-2) var(--gc-space-3) var(--gc-space-2) 36px", backgroundColor: "var(--gc-surface-2)", border: "1px solid var(--gc-border)", borderRadius: "var(--gc-radius-sm)", color: "var(--gc-text-primary)", fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-base)", width: 220, outline: "none" }} />
        </div>
      </div>

      {/* Carrier Table */}
      <div style={{ backgroundColor: "var(--gc-surface)", border: "1px solid var(--gc-border)", borderRadius: "var(--gc-radius-md)", overflow: "hidden" }}>
        {/* Header */}
        <div className="grid" style={{ gridTemplateColumns: "22% 28% 10% 10% 10% 12% 8%", padding: "var(--gc-space-3) var(--gc-space-4)", borderBottom: "1px solid var(--gc-border)" }}>
          {["Carrier", "Products", "Agents", "AM Best", "States", "Processing", ""].map(h => (
            <div key={h} style={{ fontFamily: "var(--gc-font-body)", fontSize: "var(--gc-text-xs)", fontWeight: 500, letterSpacing: "var(--gc-tracking-wider)", textTransform: "uppercase" as const, color: "var(--gc-text-secondary)" }}>{h}</div>
          ))}
        </div>
                        ...
                        {carrier.agentsAppointed.map(a => (
                          <div key={a.agentId} className="flex items-center justify-between" style={{ padding: "var(--gc-space-2) var(--gc-space-3)", backgroundColor: "var(--gc-surface-2)", borderRadius: "var(--gc-radius-sm)" }}>
                            ...
                            <div className="flex items-center gap-4" style={{ fontSize: "var(--gc-text-sm)" }}>
                              <span style={{ fontFamily: "monospace", color: "var(--gc-gold)" }}>{a.writing}</span>
                              <span style={{ color: "var(--gc-text-muted)" }}>{a.date}</span>
                              <span style={{ fontFamily: "var(--gc-font-display)", fontWeight: 600, color: "var(--gc-gold)" }}>{a.level}</span>
                            </div>
                          </div>
                        ))}
                      </div>
