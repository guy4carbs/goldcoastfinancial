    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fffaf3] via-white to-[#f5f0e8]">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="w-16 h-16 bg-violet-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <ShieldOff className="w-8 h-8 text-violet-500" />
            </div>
      ...
      <section className="py-8 md:py-12 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          >
            {/* Important Notice */}
            <div className="bg-green-50 border border-green-200 rounded-2xl p-4 md:p-6 mb-6 md:mb-8">
              <div className="flex items-start gap-3 md:gap-4">
                <div className="w-9 h-9 md:w-10 md:h-10 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Shield className="w-4 h-4 md:w-5 md:h-5 text-green-600" />
                </div>
                <div>
                  <h3 className="font-bold text-green-800 mb-1 md:mb-2 text-sm md:text-base">Heritage Life Solutions Does Not Sell Your Data</h3>
            ...
            <div className="mb-6 md:mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-primary mb-3 md:mb-4 text-balance">Your Privacy Rights</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <div key={right.title} className="bg-gray-50 rounded-xl p-3 md:p-4">
                    <div className="flex items-start gap-2 md:gap-3">
                      <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-violet-500 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="font-semibold text-primary text-sm md:text-base">Right to {right.title}</p>
                        <p className="text-xs md:text-sm text-gray-600">{right.description}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 md:p-6 mb-6 md:mb-8">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-blue-800 mb-1 md:mb-2 text-sm md:text-base">Information We May Share</h3>
                  <p className="text-blue-700 text-xs md:text-sm mb-3 md:mb-4 leading-relaxed">
      ...
      <section className="py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h2 className="text-xl md:text-2xl font-bold text-primary mb-2 text-balance">Submit Your Request</h2>
            ...
            {isSubmitted ? (
              <motion.div
                ...
                className="bg-white rounded-2xl p-5 md:p-8 shadow-sm border border-gray-100 text-center"
              >
                ...
                <h3 className="text-lg md:text-xl font-bold text-primary mb-2">Request Submitted</h3>
              ...
              >
                ...
                <div className="mb-4 md:mb-6">
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent text-sm md:text-base min-h-[44px]"
                  >
                ...
                <div className="mb-4 md:mb-6">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent resize-none text-sm md:text-base"
                ...
                <motion.button
                  ...
                  className="w-full bg-primary hover:bg-primary/90 text-white py-3 md:py-4 rounded-xl font-semibold flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed text-sm md:text-base min-h-[48px]"
                >
                  {isSubmitting ? (
                    <>
                    ...
                    <>
                      Submit Request <Send className="w-4 h-4 md:w-5 md:h-5" />
                    </>
                  )}
                </motion.button>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-6 md:mb-8"
          >
            <h2 className="text-xl md:text-2xl font-bold text-primary mb-2 text-balance">Other Ways to Submit</h2>
            <p className="text-sm md:text-base text-gray-600 text-pretty">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            >
              ...
              <h3 className="font-bold text-primary mb-1 md:mb-2 text-sm md:text-base">By Phone</h3>
              <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">Call our privacy hotline</p>
              <a href="tel:6307780800" className="text-primary font-medium hover:text-violet-500 text-sm md:text-base min-h-[44px] inline-flex items-center">
                (630) 778-0800
              </a>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-bold text-primary mb-1 md:mb-2 text-sm md:text-base">By Email</h3>
              <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">Email our privacy team</p>
              <a href="mailto:privacy@heritagels.org" className="text-primary font-medium hover:text-violet-500 text-sm md:text-base min-h-[44px] inline-flex items-center">
            ...
            >
              ...
              <h3 className="font-bold text-primary mb-1 md:mb-2 text-sm md:text-base">By Mail</h3>
              <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">Send written request to:</p>
              <MapSelector>
                <span className="text-xs md:text-sm text-gray-600 hover:text-primary transition-colors block cursor-pointer">
