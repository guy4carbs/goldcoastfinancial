    ...
    <section id="about" ref={ref} className="py-20 md:py-28 bg-[#111111]" style={{ fontFamily: SANS }}>
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-white/50 max-w-2xl mx-auto mt-5 leading-relaxed text-sm">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
          {STATS.map((stat, i) => (
            ...
            >
              <span
                className="text-3xl md:text-4xl text-[#E8C96B] font-bold"
                style={{ fontFamily: SERIF }}
              >
                {stat.number}
              </span>
              <p className="text-white/40 text-xs mt-2 whitespace-nowrap">{stat.label}</p>
            </motion.div>
          ))}
        </div>
      </div>
