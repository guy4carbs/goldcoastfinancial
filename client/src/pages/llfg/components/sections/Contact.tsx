      ...
      >
        ...
        <div className="flex justify-center gap-10 mt-8">
          <a
            ...
            className="flex items-center gap-2 text-[#E8C96B] text-sm font-medium hover:text-white transition-colors whitespace-nowrap"
          >
            <Mail size={14} className="text-[#B8963C]" />
            support@llfg.us
          </a>
          <a
            href="https://llfg.us"
            ...
            className="flex items-center gap-2 text-[#E8C96B] text-sm font-medium hover:text-white transition-colors whitespace-nowrap"
          >
            <Globe size={14} className="text-[#B8963C]" />
            llfg.us
          </a>
        </div>
      </motion.div>
