  ...
  const renderModuleContent = () => {
    switch (activeModule) {
      ...
      case 1:
        return (
          <>
            <VideoPlaceholder title="Term vs. Whole Life: Which Should You Choose?" />
      ...
      case 2:
        return (
          <>
            <VideoPlaceholder title="Calculate Your Perfect Coverage Amount" />
      ...
      case 4:
        return (
          <>
            <VideoPlaceholder title="How Life Insurance Premiums Are Calculated" />
      ...
      case 5:
        return (
          <>
            <VideoPlaceholder title="Understanding Beneficiaries & Claim Payouts" />
