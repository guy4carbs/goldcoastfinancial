...
export enum EventType {
  ...
  HIERARCHY_REQUEST_CREATED = 'HIERARCHY_REQUEST_CREATED',
  HIERARCHY_REQUEST_MANAGER_REVIEWED = 'HIERARCHY_REQUEST_MANAGER_REVIEWED',
  HIERARCHY_REQUEST_EXECUTIVE_REVIEWED = 'HIERARCHY_REQUEST_EXECUTIVE_REVIEWED',
  HIERARCHY_REQUEST_COMPLETED = 'HIERARCHY_REQUEST_COMPLETED',
  ...
  // Tier 11–12 — Governance Swarm
  GOVERNANCE_TASK_SUBMITTED = 'GOVERNANCE_TASK_SUBMITTED',
  GOVERNANCE_TASK_DECOMPOSED = 'GOVERNANCE_TASK_DECOMPOSED',
  GOVERNANCE_TASK_ASSIGNED = 'GOVERNANCE_TASK_ASSIGNED',
  GOVERNANCE_TASK_COMPLETED = 'GOVERNANCE_TASK_COMPLETED',
  GOVERNANCE_TASK_FAILED = 'GOVERNANCE_TASK_FAILED',

  GOVERNANCE_SUBTASK_STARTED = 'GOVERNANCE_SUBTASK_STARTED',
  GOVERNANCE_SUBTASK_COMPLETED = 'GOVERNANCE_SUBTASK_COMPLETED',
  GOVERNANCE_SUBTASK_BLOCKED = 'GOVERNANCE_SUBTASK_BLOCKED',

  GOVERNANCE_HANDOFF_REQUESTED = 'GOVERNANCE_HANDOFF_REQUESTED',
  GOVERNANCE_HANDOFF_ACCEPTED = 'GOVERNANCE_HANDOFF_ACCEPTED',
  GOVERNANCE_HANDOFF_COMPLETED = 'GOVERNANCE_HANDOFF_COMPLETED',
  GOVERNANCE_HANDOFF_REJECTED = 'GOVERNANCE_HANDOFF_REJECTED',

  CHANGE_CHAIN_STARTED = 'CHANGE_CHAIN_STARTED',
  CHANGE_CHAIN_STEP_COMPLETED = 'CHANGE_CHAIN_STEP_COMPLETED',
  CHANGE_CHAIN_STEP_REJECTED = 'CHANGE_CHAIN_STEP_REJECTED',
  CHANGE_CHAIN_COMPLETED = 'CHANGE_CHAIN_COMPLETED',
  CHANGE_CHAIN_FAILED = 'CHANGE_CHAIN_FAILED',

  GOVERNANCE_VETO_ISSUED = 'GOVERNANCE_VETO_ISSUED',
  GOVERNANCE_VETO_RESOLVED = 'GOVERNANCE_VETO_RESOLVED',
  GOVERNANCE_VETO_OVERRIDE_ATTEMPTED = 'GOVERNANCE_VETO_OVERRIDE_ATTEMPTED',

  GOVERNANCE_DOMAIN_VIOLATION = 'GOVERNANCE_DOMAIN_VIOLATION',
  GOVERNANCE_RELEASE_CHECK = 'GOVERNANCE_RELEASE_CHECK',
  GOVERNANCE_RELEASE_APPROVED = 'GOVERNANCE_RELEASE_APPROVED',
  GOVERNANCE_RELEASE_BLOCKED = 'GOVERNANCE_RELEASE_BLOCKED',

  GOVERNANCE_CONFLICT = 'GOVERNANCE_CONFLICT',
  GOVERNANCE_CONFLICT_RESOLVED = 'GOVERNANCE_CONFLICT_RESOLVED',
}
