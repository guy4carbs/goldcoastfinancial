...
async function seedIfEmpty(userId: string) {
  try {
    ...
    await storage.createNotification({
      ...
      message: "This is where you'll see document updates, carrier approvals, and anything else that needs your attention. Take the walkthrough any time from the bottom-right.",
      type: "welcome",
