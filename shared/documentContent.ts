/**
 * Shared document content for Gold Coast Financial Partners LLC onboarding documents.
...
export const DOCUMENT_CONTENT: Record<string, DocumentDefinition> = {
  ...
  nda: {
    ...
    sections: [
      {
        heading: 'PARTIES',
        body: 'This Non-Disclosure, Non-Use, Non-Solicitation, and Lead Protection Agreement ("Agreement") is entered into as of the date of electronic signature below, by and between Gold Coast Financial Partners, LLC, d/b/a Heritage Life Solutions, an Illinois limited liability company, located at 1240 Iroquois Avenue, Naperville, Illinois ("Company"), and the undersigned individual ("Recipient" or "Agent"). The Company and the Agent are collectively referred to as the "Parties."',
      },
      {
        heading: '1. PURPOSE',
  ...
  debt_rollup: {
    ...
    sections: [
      {
        heading: 'PARTIES',
        body: 'This Debt Roll-Up Protection and Authorization Agreement ("Agreement") is entered into as of the date of electronic signature below, by and between Gold Coast Financial Partners, LLC, d/b/a Heritage Life Solutions ("Company" or "Creditor"), and the undersigned independent contractor agent ("Agent" or "Debtor").',
      },
      {
        heading: '1. PURPOSE',
  ...
  compliance: {
    ...
    sections: [
      {
        heading: 'PARTIES',
        body: 'This Compliance and Ethical Conduct Agreement ("Agreement") is entered into as of the date of electronic signature below by the undersigned agent ("Agent") in connection with the Agent\'s engagement with Gold Coast Financial Partners, LLC, d/b/a Heritage Life Solutions ("Company" or "Agency"). The Company requires strict adherence to all applicable laws, carrier guidelines, and ethical standards in order to protect clients, insurance carriers, and the Company.',
      },
      {
        heading: '1. PURPOSE',
