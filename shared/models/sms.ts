...
export const smsMessages = pgTable("sms_messages", {
  ...
  status: text("status").notNull().default("queued").$type<"queued" | "sending" | "sent" | "delivered" | "failed" | "sending_failed" | "delivery_failed" | "delivery_unconfirmed" | "expired" | "received">(),
